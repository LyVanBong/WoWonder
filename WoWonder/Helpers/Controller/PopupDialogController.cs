    ...
    public class PopupDialogController
    {
        public class TimePickerFragment : AndroidX.Fragment.App.DialogFragment, TimePickerDialog.IOnTimeSetListener
        {
            ...
            public override Dialog OnCreateDialog(Bundle savedInstanceState)
            {
                ...
                TimePickerDialog dialog = new TimePickerDialog(Activity, AppSettings.SetTabDarkTheme ? Resource.Style.MyTimePickerDialogTheme_Dark : Resource.Style.MyTimePickerDialogTheme, this, currentTime.Hour, currentTime.Minute, is24HourFormat);
                return dialog;
            }
